!(function (e) {
  function t(t) {
    for (var n, a, i = t[0], l = t[1], f = t[2], p = 0, s = []; p < i.length; p++)
  ...
  (a.m = e),
    ...
    (a.p = '/DzmitryI/DIMS.UI-3/');
  var i = (this['webpackJsonpdev-incubator-management-system'] =
      this['webpackJsonpdev-incubator-management-system'] || []),
    l = i.push.bind(i);
  (i.push = t), (i = i.slice());
...
//# sourceMappingURL=runtime-main.f2cd7caf.js.map
